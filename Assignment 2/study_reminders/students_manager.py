...
class StudentsManager:
    ...
    def load_students(self):
        ...
        try:
            ...
            return [
                {"name": "Alice", "email": "alice@example.com", "course": "Computer Science", "preferred_time": "08:00AM"},
                {"name": "Bob", "email": "bob@example.com", "course": "Mathematics", "preferred_time": "09:00AM"},
                {"name": "Charlie", "email": "charlie@example.com", "course": "Physics", "preferred_time": "07:30AM"}
            ]
